...
export default function NavigationScreen() {
  const nav =
    useNavigation<NativeStackNavigationProp<RootStackParamList, "Safety">>();
  ...
  const distance = params?.routeData
    ? formatDistance(params.routeData.totalDistanceMeters)
    : "—";
  const timeInfo = params?.routeData
    ? formatRemainingTime(params.routeData.totalTimeSeconds)
    : null;
          ...
          <View style={styles.currentStepCard}>
            ...
            <View style={{ flex: 1 }}>
              ...
              {currentStep.streetName ? (
                <Text style={styles.currentStepStreet}>
                  {currentStep.streetName}
                </Text>
              ) : null}
              {currentStep.distance > 0 ? (
                <Text style={styles.currentStepDist}>
          ...
          <View style={styles.upcomingCard}>
            ...
            {upcomingSteps.map((step, idx) => (
              <View
                ...
                style={[
                  styles.upcomingRow,
                  idx < upcomingSteps.length - 1 && styles.upcomingRowBorder,
                ]}
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.upcomingInstruction}>
                    {step.instruction}
                  </Text>
                  {step.streetName ? (
